...
#UsrAnsr_InputfileLoc = input("Please provide the location of CycleRoutes.TAB in speech marks")

# os.system('C:') #this fails
# os.system('cd "C:\Program Files\QGIS Wien\bin\ogr2ogr.exe"') #this fails

cmd="ogr2ogr -f \"KML\" \"C:/Users/Robert Limited/Documents/Temporary Items/KMLextractfile.kml\" \"C:/Users/Robert Limited/Documents/Temporary Items/TempCycleroutes/CycleRoutes.TAB\" -sql \"select RouteNumber AS name from CycleRoutes where ((RouteType = 1 or RouteType = 2) and OpenStatus >= 3)\""
